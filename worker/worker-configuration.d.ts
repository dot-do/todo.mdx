/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b750a26797fda51446a2f15d64764ee)
// Runtime types generated with workerd@1.20251217.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RepoDO" | "ProjectDO" | "TodoMCP";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		REPO: DurableObjectNamespace<import("./src/index").RepoDO>;
		PROJECT: DurableObjectNamespace<import("./src/index").ProjectDO>;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").TodoMCP>;
		DB: D1Database;
		PAYLOAD: Service /* entrypoint PayloadRPC from admin-todo-mdx */;
		VECTORIZE: VectorizeIndex;
		AI: Ai;
		DEVELOP_WORKFLOW: Workflow<Parameters<import("./src/index").DevelopWorkflow['run']>[0]['payload']>;
		EMBED_WORKFLOW: Workflow<Parameters<import("./src/index").EmbedWorkflow['run']>[0]['payload']>;
		BULK_EMBED_WORKFLOW: Workflow<Parameters<import("./src/index").BulkEmbedWorkflow['run']>[0]['payload']>;
	}
}
